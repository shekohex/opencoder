...
class ApiMethods {
	...
	getUserParameters = async (templateID: string) => {
		return this.request<TypesGen.UserParameter[]>(
			"GET",
			"/api/v2/users/me/autofill-parameters",
			{ params: { template_id: templateID } },
		);
	};

	getAuthMethods = async (): Promise<TypesGen.AuthMethods> => {
		return this.request<TypesGen.AuthMethods>(
			"GET",
	...
	getUserLoginType = async (): Promise<TypesGen.UserLoginType> => {
		return this.request<TypesGen.UserLoginType>(
			"GET",
	...
	getApiKey = async (): Promise<TypesGen.GenerateAPIKeyResponse> => {
		return this.request<TypesGen.GenerateAPIKeyResponse>(
			"POST",
	...
	getTokens = async (
		...
		try {
			return await this.request<TypesGen.APIKeyWithOwner[]>(
				"GET",
	...
	createOrganization = async (params: TypesGen.CreateOrganizationRequest) => {
		return this.request<TypesGen.Organization>(
			"POST",
	...
	updateTemplateMeta = async (
		...
		try {
			return await this.request<TypesGen.Template>(
				"PATCH",
				`/api/v2/templates/${templateId}`,
				{ body: data },
			);
	...
	getWorkspaces = async (
		...
		return this.request<TypesGen.WorkspacesResponse>(
			"GET",
			"/api/v2/workspaces",
			{
	...
	getUpdateCheck = async (): Promise<TypesGen.UpdateCheckResponse> => {
		return this.request<TypesGen.UpdateCheckResponse>(
			"GET",
			"/api/v2/updatecheck",
		);
	};
	...
	getAppearanceSettings =
		async (): Promise<TypesGen.UserAppearanceSettings> => {
			return this.request<TypesGen.UserAppearanceSettings>(
				"GET",
	...
	getUserPreferenceSettings =
		async (): Promise<TypesGen.UserPreferenceSettings> => {
			return this.request<TypesGen.UserPreferenceSettings>(
				"GET",
	...
	createFirstUser = async (
		...
		return this.request<TypesGen.CreateFirstUserResponse>(
			"POST",
			"/api/v2/users/first",
			{
				body: req,
	...
	getUserSSHKey = async (userId = "me"): Promise<TypesGen.GitSSHKey> => {
		return this.request<TypesGen.GitSSHKey>(
			"GET",
	...
	getEntitlements = async (): Promise<TypesGen.Entitlements> => {
		try {
			return await this.request<TypesGen.Entitlements>(
				"GET",
				"/api/v2/entitlements",
			);
		} catch (ex) {
	...
	getExperiments = async (): Promise<TypesGen.Experiment[]> => {
		try {
			return await this.request<TypesGen.Experiment[]>(
				"GET",
				"/api/v2/experiments",
			);
		} catch (error) {
	...
	getExternalAuthProvider = async (
		...
		return this.request<TypesGen.ExternalAuth>(
			"GET",
	...
	getUserExternalAuthProviders =
		async (): Promise<TypesGen.ListUserExternalAuthResponse> => {
			return this.request<TypesGen.ListUserExternalAuthResponse>(
				"GET",
	...
	getOAuth2ProviderApps = async (
		...
		return this.request<TypesGen.OAuth2ProviderApp[]>(
			"GET",
	...
	getConnectionLogs = async (
		...
		return this.request<TypesGen.ConnectionLogResponse>(
			"GET",
	...
	getTemplateDAUs = async (
		...
		return this.request<TypesGen.DAUsResponse>(
			"GET",
	...
	getTemplateACL = async (
		...
		return this.request<TypesGen.TemplateACL>(
			"GET",
	...
	getWorkspaceACL = async (
		...
		return this.request<TypesGen.WorkspaceACL>(
			"GET",
	...
	getApplicationsHost = async (): Promise<TypesGen.AppHostResponse> => {
		return this.request<TypesGen.AppHostResponse>(
			"GET",
	...
	getDeploymentSSHConfig = async (): Promise<TypesGen.SSHConfigResponse> => {
		return this.request<TypesGen.SSHConfigResponse>(
			"GET",
	...
	getDeploymentStats = async (): Promise<TypesGen.DeploymentStats> => {
		return this.request<TypesGen.DeploymentStats>(
			"GET",
	...
	> => {
		return this.request<TypesGen.RegionsResponse<TypesGen.Region>>(
			"GET",
			"/api/v2/regions",
		);
	};
	...
	createWorkspaceProxy = async (
		...
		return this.request<TypesGen.UpdateWorkspaceProxyResponse>(
			"POST",
			"/api/v2/workspaceproxies",
			{ body: b },
		);
	...
	getAppearance = async (): Promise<TypesGen.AppearanceConfig> => {
		try {
			const res = await this.request<TypesGen.AppearanceConfig>(
				"GET",
				"/api/v2/appearance",
			);
			return res || {};
	...
	updateAppearance = async (
		...
		return this.request<TypesGen.AppearanceConfig>(
			"PUT",
			"/api/v2/appearance",
			{
				body: b,
	...
	getTemplateExamples = async (): Promise<TypesGen.TemplateExample[]> => {
		return this.request<TypesGen.TemplateExample[]>(
			"GET",
	...
	createLicense = async (
		...
		return this.request<TypesGen.AddLicenseRequest>(
			"POST",
			"/api/v2/licenses",
			{
				body: data,
	...
	getInsightsTemplate = async (
		...
		return this.request<TypesGen.TemplateInsightsResponse>(
			"GET",
	...
	getHealth = async (force = false) => {
		return this.request<TypesGen.HealthcheckReport>(
			"GET",
			"/api/v2/debug/health",
			{
	...
	getHealthSettings = async (): Promise<TypesGen.HealthSettings> => {
		return this.request<TypesGen.HealthSettings>(
			"GET",
	...
	getOrganizationProvisionerJobs = async (
		orgId: string,
	...
	getInboxNotifications = async (startingBeforeId?: string) => {
		return this.request<TypesGen.ListInboxNotificationsResponse>(
			...
			{
				params: startingBeforeId
					? { starting_before: startingBeforeId }
					: undefined,
			},
		);
	};
	...
	getTasks = async (
		...
		const res = await this.request<TypesGen.TasksListResponse>(
			"GET",
			"/api/v2/tasks",
			{
				params: { q: query.join(", ") },
